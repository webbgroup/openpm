...
class Admin extends CI_Controller {
	...
	public function addResProperty() {
		...
		if ($forsale_val == '1') {
			if ($typeId_val == 53 || $typeId_val == 55 || $typeId_val == 54 || $typeId_val == 60 || $typeId_val == 63 || $typeId_val == 62 || $typeId_val == 61 || $typeId_val == 77 || $typeId_val == 76 || $typeId_val == 78) {
			...
			} else if ($typeId_val == 57 || $typeId_val == 56 || $typeId_val == 67) {
				...
				if ($typeId_val == 15 || $typeId_val == 16 || $typeId_val == 12 || $typeId_val == 17 || $typeId_val == 18 || $typeId_val == 64 || $typeId_val == 13 || $typeId_val == 14 ||
					$typeId_val == 22 || $typeId_val == 23 || $typeId_val == 21 || $typeId_val == 24 || $typeId_val == 30 || $typeId_val == 93 || $typeId_val == 65 || $typeId_val == 32 ||
					$typeId_val == 32 || $typeId_val == 29 || $typeId_val == 31 || $typeId_val == 28 || $typeId_val == 27 || $typeId_val == 25 || $typeId_val == 26 || $typeId_val == 66 ||
					$typeId_val == 33 || $typeId_val == 96 || $typeId_val == 95 || $typeId_val == 94 || $typeId_val == 34 || $typeId_val == 97 || $typeId_val == 35 ||
					$typeId_val == 80 || $typeId_val == 20 || $typeId_val == 19 || $typeId_val == 81 || $typeId_val == 79 || $typeId_val == 41 || $typeId_val == 39 || $typeId_val == 36 ||
					$typeId_val == 43 || $typeId_val == 38 || $typeId_val == 40 || $typeId_val == 44 || $typeId_val == 42 || $typeId_val == 37) {
					...
					$to_db_arr = array("title" => $this->input->post('intefloortitle_com_sale'),
	...
	public function validateUsername() {
		...
		if ($result) {
			$val = array("success" => "username_exist");
			$output = json_encode($val);
			echo $output;
		} else {
			$val = array("success" => "username not exist");
			$output = json_encode($val);
			echo $output;
		}
	}
	...
	public function validateOldPassword() {
		...
		if ($result) {
			$val = array("success" => "password_correct");
			$output = json_encode($val);
			echo $output;
		} else {
			$val = array("success" => "password not correct");
			$output = json_encode($val);
			echo $output;
		}
	}
	...
	public function saveColor() {
		if ($this->session->userdata('id') == 1) {
			...
			if ($container == "footer_color") {
				$color = $this->input->post("footer_color");
				$db_data = array('ckey' => $container, 'cvalue' => $color);
	...
	public function saveTitle() {
		if ($this->session->userdata('id') == 1) {
			$title = $this->input->post("title");
			$db_data = array('ckey' => 'site_title', 'cvalue' => $title);
	...
	public function saveLogo() {
		...
		$file_data = $this->upload->data();
		$db_data = array('ckey' => 'site_logo', 'cvalue' => $file_data['file_name']);
	...
	public function saveHycolor() {
		if ($this->session->userdata('id') == 1) {
			$db_data = array('ckey' => 'hylinkcolor', 'cvalue' => $this->input->post('hycolor'));
	...
	public function savebtncolor() {
		if ($this->session->userdata('id') == 1) {
			$db_data = array('ckey' => 'btn_color', 'cvalue' => $this->input->post('color'));
	...
	public function adminSCEmail() {
		if ($this->session->userdata('id') == 1) {
			$email = $this->input->post('email');
			$db_data = array('ckey' => 'admin_email', 'cvalue' => $email);
	...
	public function officeLoc() {
		if ($this->session->userdata('id') == 1) {
			...
			$db_data = array('ckey' => 'map_location', 'cvalue' => $location);
	...
	*/
	...
	public function saveBannor() {
		if ($this->session->userdata('id') == 1) {
			$db_data = array('ckey' => 'banner_color', 'cvalue' => $this->input->post('color'));
	...
	public function adminSCEmailPass() {
		if ($this->session->userdata('id') == 1) {
			...
			$db_data = array('ckey' => 'admin_smtp_pass', 'cvalue' => $smtppassword);
