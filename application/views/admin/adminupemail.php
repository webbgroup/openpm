		...
		<div class="main-content">
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<form action="<?php echo base_url(); ?>admin/adminSCEmail" method="post" enctype="multipart/form-data">
												<div class="row">
														<div class="form-group">																						
														<label class="col-sm-3 control-label no-padding-right"> Contact Email</label>
														<div class="col-xs-5 col-sm-4">
                                                                                                                      <?php if ($res) {?>
														<input type="text" class="col-xs-10 col-sm-10" id="email_ad" name="email" value="<?php echo $res['contents']->cvalue; ?>" required/>
                                                                                                                      <?php }?>
                                                                                                                </div>
														</div>
