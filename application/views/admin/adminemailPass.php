		...
		<div class="main-content">
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<h5 class="smaller">SMTP Password</h5>
												...
												<form action="<?php echo base_url(); ?>admin/adminSCEmailPass" method="post" enctype="multipart/form-data">
												<div class="row">
														<div class="form-group">																						
														<label class="col-sm-3 control-label no-padding-right"> SMTP Password</label>
														<div class="col-xs-5 col-sm-4">
														 
														<input type="text" class="col-xs-10 col-sm-10"  id="smtppassword" name="smtppassword" required/>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																	<button class="btn btn-success" id="btn_email" type="submit"> Save </button>
														</div>
