										...
										<div class="widget-box">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker2" type="text" class="input-small" name="footercolor" value="<?php echo $content->cvalue; ?>"/>
															</div>
														</div>
														<div class="col-xs-5 col-sm-4">
																<span class="error_text_color" style="color:red;"></span>
														</div>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																<button class="btn btn-success" id="btn_footer" type="button"> Update </button>
														</div>
			...
			$(document).ready(function(){
				...
				$('#colorpicker2').colorpicker();
		  		$("#btn_footer").click(function(){
		  				var footer_color = $('#colorpicker2').val();
		  				if(footer_color==""){
		  					$(".error_text_color").html("Required");
		  					return false;
		  				}else{
		  				$.ajax({
						        type: 'POST',
						        ...
						        cache: false,
						        data:'footer_color='+footer_color+'&container=footer_color',
