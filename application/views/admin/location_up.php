				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<div class="row">
														...
														<?php if ($res) { ?>
														<textarea  name="location" class="form-control" maxlength="100" placeholder="Please enter map location" required><?php echo $res['contents']->cvalue; ?></textarea>
														<?php } ?>
														</div>
														</div>
