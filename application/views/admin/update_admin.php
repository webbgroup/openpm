				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<div class="widget-toolbar no-border">
													...
													<form id="agents_form" action="<?php echo base_url();?>admin/updateAdmin" method="post" enctype="multipart/form-data">
												...
												<div class="row">
														...
														<input  type="file" id="id-input-file-user" name="pic" id="pic" />
														</div>
														</div>
