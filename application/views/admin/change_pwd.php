		...
		<div class="main-content">
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<h5 class="smaller">Change Password</h5>
												...
												<div class="widget-toolbar no-border">
													...
													<form id="pwd_form" action="<?php echo base_url(); ?>admin/updatePwd" method="post" enctype="multipart/form-data">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																<input id="password" class="col-xs-10 col-sm-6" type="text" name="password" value=""required>	
														</div>
														<div class="col-xs-5 col-sm-4">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
														<input id="newpwd" class="col-xs-10 col-sm-6" type="text" name="newpwd" value="" required>
														</div>
												...
												<div class="row">
														...
														<input id="cnewpwd" class="col-xs-10 col-sm-6" type="text" name="cnewpwd" value="" required>	
													
														</div>
														<div class="col-xs-5 col-sm-4">
																<span class="error_text_password"></span>
														</div>
		  ...
		  submitHandler: function(form) {
			...
			var valid2 =false;
						        ...
						        async : false,
						        	success: function(data) {
						        		if(data.success == "password_correct"){
						                    ...
						                    $('.error_text_username').css("color", "green");
						                   valid1 = true;

						                }else {
						                	 $('.error_text_username').html('Wrong Password');
						                	 $('.error_text_username').css("color", "red");
						                	valid1 = false;
						                }
						        	}
				...
				if(new_pass==c_pass){
					...
					$('.error_text_password').html('Password Mismatch')
