		...
		<div class="main-content">
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<h5 class="smaller">Hyperlink color</h5>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker2" type="text" class="input-small" name="hycolor"/>
															</div>
														</div>
														<div class="col-xs-5 col-sm-4">
																<span class="error_text_hycolor" style="color:red;"></span>
														</div>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																<button class="btn btn-success" id="btn_hy" type="button"> Save </button>
														</div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#colorpicker2').colorpicker();
		  		$("#btn_hy").click(function(){
		  				var hycolor = $('#colorpicker2').val();
		  				if(hycolor==""){
		  					$(".error_text_hycolor").html("Required");
		  					return false;
		  				}else{
		  				$.ajax({
						        type: 'POST',
						        url: "<?php echo base_url(); ?>admin/saveHycolor",
						        cache: false,
						        data:'hycolor='+hycolor,
