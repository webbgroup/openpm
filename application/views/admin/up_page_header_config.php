...
<?php $this->load->view('admin/admin_sidebar'); ?>
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<div class="widget-toolbar no-border">
													...
													<form id="pwd_form" action="<?php echo base_url(); ?>admin/updateColor" method="post" enctype="multipart/form-data">
    ...
    foreach ($contents as $content) {
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker1" type="text" class="input-small" name="header_color" value="<?php echo $content->cvalue; ?>" required/>
																<input  type="hidden" name="container" value="header_color"/>
															</div>
														</div>
														<div class="col-xs-5 col-sm-4">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																	<button class="btn btn-success" id="btn_header" type="submit"> Update </button>
														</div>
		...
		$("#pic").change(function(){
		    readPic( this );
		  		...
		  		/*$("#btn_header").click(function(){
		  				var header_color = $('#colorpicker1').val();
		  				$.ajax({
						        type: 'POST',
						        url: "<?php echo base_url(); ?>admin/updateColor",
						        cache: false,
						        data:'header_color='+header_color+'&container=header',
