    ...
    foreach ($contents as $content) {
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<h5 class="smaller">Update button color</h5>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker2" type="text" class="input-small" name="btncolor" value="<?php echo $content->cvalue; ?>"/>
															</div>
														</div>
														<div class="col-xs-5 col-sm-4">
			...
			$(document).ready(function(){
				...
				$('#colorpicker2').colorpicker();
		  		$("#btn_hyper").click(function(){
		  				...
		  				$.ajax({
						        type: 'POST',
						        url: "<?php echo base_url(); ?>admin/updatebtncolor",
						        cache: false,
						        data:'color='+color,
