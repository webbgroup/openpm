										...
										<div class="widget-box">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker2" type="text" class="input-small" name="btncolor"/>
															</div>
														</div>
														<div class="col-xs-5 col-sm-4">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																<button class="btn btn-success" id="btn_btcolor" type="button"> Save </button>
														</div>
			...
			$(document).ready(function(){
				...
				$('#colorpicker2').colorpicker();
		  		$("#btn_btcolor").click(function(){
		  				...
		  				$.ajax({
						        type: 'POST',
						        url: "<?php echo base_url(); ?>admin/savebtncolor",
						        cache: false,
						        data:'color='+color,
