				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<div class="widget-toolbar no-border">
													...
													<form id="pwd_form" action="<?php echo base_url();?>admin/saveColor" method="post" enctype="multipart/form-data">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker1" type="text" class="input-small" name="header_color" required/>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																	<button class="btn btn-success" id="btn_header" type="submit"> Save </button>
														</div>
