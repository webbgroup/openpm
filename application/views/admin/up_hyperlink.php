    ...
    foreach ($contents as $content) {
				...
				<div class="col-sm-12 widget-container-span ui-sortable">
										<div class="widget-box">
												...
												<h5 class="smaller">Update hyperlink color</h5>
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																...
																<input id="colorpicker2" type="text" class="input-small" name="hycolor" value="<?php echo $content->cvalue; ?>"/>
															</div>
														</div>
														<div class="col-xs-5 col-sm-4">
												...
												<div class="row">
														...
														<div class="col-xs-5 col-sm-4">
																<button class="btn btn-success" id="btn_hyper" type="button"> Update </button>
														</div>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#colorpicker2').colorpicker();
		  		$("#btn_hyper").click(function(){
		  				var hycolor = $('#colorpicker2').val();
		  				if(hycolor==""){
		  					$(".error_text").html("Required");
		  					return false;
		  				}else{
		  				$.ajax({
						        type: 'POST',
						        url: "<?php echo base_url(); ?>admin/updateHycolor",
						        cache: false,
