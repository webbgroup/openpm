...
<div class="container">
  <div class="properties-listing spacer">
	...
	?>
           ...
           <div class="row">
            <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url();?>uploads/<?php $img_arr = explode(",", $hotproperty['filename']);
	echo $img_arr[0];?>" class="img-responsive img-circle" alt="properties"/></div>
...
?>
  ...
  <?php }
?>
  <?php if ($res['waterfront'] != 0) {?>
  <div class="row">
  <div class="col-lg-6 divpop">waterfront</div><div class="col-lg-6">Yes</div>
  </div>
  <?php }
?>
  <?php if ($res['commPool'] != 0) {?>
  <div class="row">
...
?>
  <?php if ($res['pool'] != 0) {?>
  <div class="row">
  <div class="col-lg-6 divpop">Pool</div><div class="col-lg-6">Yes</div>
  </div>
  <?php }
?>
...
?>
  <?php if ($res['fmv'] != 0) {?>
  <div class="row">
  <div class="col-lg-6 divpop">Fair Market Value</div><div class="col-lg-6"><?php echo $res['fmv'];?></div>
  </div>
  <?php }
?>
  <?php if ($res['mls'] != 0) {?>
...
<h5><span class="glyphicon glyphicon-th-list"></span> Interior Information</h5>
 <!--  <?php if ($res['tpwater'] != 0) {?>
 <div class="row">
 <div class="col-lg-6">Tenant pays water</div><div class="col-lg-6">Yes</div>
 </div>
 <?php }
?>
 <?php if ($res['tpelectricity'] != 0) {?>
 <div class="row">
 <div class="col-lg-6">Tenant pays electricity</div><div class="col-lg-6">Yes</div>
 </div>
 <?php }
?> -->
  <?php if ($res['carpeted'] != 0) {?>
  <div class="row">
  <div class="col-lg-6 divpop">Carpeted</div><div class="col-lg-6">Yes</div>
  </div>
  <?php }
?>
  <?php if ($res['dishwasher'] != 0) {?>
  <div class="row">
  <div class="col-lg-6 divpop"> Dishwasher</div><div class="col-lg-6">Yes</div>
  </div>
  <?php }
?>
  <?php if ($res['gasstove'] != 0) {?>
  <div class="row">
  <div class="col-lg-6 divpop">Gas stove</div><div class="col-lg-6">Yes</div>
  </div>
  <?php }
?>
  <?php if ($res['hardwood'] != 0) {?>
  <div class="row">
...
<div class="col-lg-4">
  <div class="col-lg-12  col-sm-6">
    ...
    <div class="listing-detail">
      <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room"><?php echo $res['beds'];?></span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bath Room"><?php echo $res['baths'];?></span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Garage Size"><?php if ($res['garagesize'] != "") {echo $res['garagesize'];} else {
	"0";
}
?></span></div>
    ...
    <div class="col-lg-12 col-sm-6 ">
      ...
      <input type="button" class="btn btn-primary" name="Submit" id="btncontacteq1" value="Send Message" />
      </form>
      </div>
    </div>
  </div>
