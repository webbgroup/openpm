...
<div class="row">
<?php if ($hotproperty['filename']) {
            ?>
<?php
/*$pic_arr=explode(",",$hotproperty['filename']);
            $filename =$pic_arr[0];;
            ...
            echo $pic_arr[0]; ?>" class="img-responsive img-circle" alt="properties"/></div>
               <?php
                 ...
                 <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url(); ?>uploads/no-image.png" class="img-responsive img-circle" alt="properties"/></div>
                <?php } ?>
...
<div class="row">
    ...
    foreach ($residential as $res) {
      ...
      <div class="properties">
        ...
        <h4><a href="<?php echo base_url(); ?>index.php/home/propertySaleDetail?id=<?php echo $res['resId']; ?>"><?php echo $res['title']; ?></a></h4>
...
?>
    ...
    foreach ($commercial as $res) {
      ...
      <div class="properties">
        ...
        <h4><a href="<?php echo base_url(); ?>index.php/home/propertyComSaleDetail?id=<?php echo $res['commId']; ?>"><?php echo $res['title']; ?></a></h4>
        <p class="price">Price: $<?php echo number_format($res['price']); ?></p>
       <!-- <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room"><?php echo $res['beds']; ?></span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bath Room"><?php echo $res['baths']; ?></span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">1</span> </div>
         --><a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/home/propertyComSaleDetail?id=<?php echo $res['commId']; ?>">View Details</a>
      </div>
      </div>
      <?php
    }
