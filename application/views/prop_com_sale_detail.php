      ...
      <div class="col-lg-3 col-sm-4 hidden-xs">
        ...
        <div class="hot-properties hidden-xs">
          ...
          <?php foreach($hotpop as $hotproperty){
           ...
           <div class="row">
            <div class="col-lg-4 col-sm-5"><img src="<?php echo base_url();?>uploads/<?php $img_arr=explode(",",$hotproperty['filename']);echo $img_arr[0]; ?>" class="img-responsive img-circle" alt="properties"/></div>
