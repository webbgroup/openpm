...
<div class="spacer"><h4><span class="glyphicon glyphicon-th-list"></span> Properties Detail</h4>
 ...
 <?php }?>
  ...
  <?php }?>
  <?php if (0 != $res['dockDoors']) {?>
<div class="row">
<div class="col-lg-6 divpop"># of dock high doors</div><div class="col-lg-6"><?php echo $res['dockDoors']; ?></div>
</div>
<?php }?>
<?php if (0 != $res['class']) {?>
<div class="row">
<div class="col-lg-6 divpop"># of dock high doors</div><div class="col-lg-6"><?php echo $res['class']; ?></div>
</div>
<?php }?>
<?php if (0 != $res['gradeDoors']) {?>
<div class="row">
<div class="col-lg-6 divpop"># of grade-level doors:</div><div class="col-lg-6"><?php echo $res['gradeDoors']; ?></div>
</div>
<?php }?>
  <?php if (0 != $res['zoning']) {?>
  <div class="row">
...
<div class="col-lg-4">
  <div class="col-lg-12  col-sm-6">
   ...
   <?php  //if($res['beds']!=="" && $res['baths']!==""){?>
     <!--  <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room"><?php echo $res['beds']; ?></span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Bath Room"><?php echo $res['baths']; ?></span> 
       -->
    <?php //}?>
    </div>
    <div class="col-lg-12 col-sm-6 ">
      ...
      <input type="button" class="btn btn-primary" name="Submit" id="btncontacteq" value="Send Message" />
      </form>
      </div>          
    </div>
  </div>
